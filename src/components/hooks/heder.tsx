...
export function Header({
    ...
    const handleLogout = () => {
        ...
        navigate("/"); // Ajusta si tu ruta de login es diferente
    };

    // Función para redirigir a la página de notificaciones
    const handleNotificationsClick = () => {
        navigate("/notificaciones"); // Ajusta la ruta según tu estructura de carpetas
    };
            ...
            <div className="flex items-center justify-between h-16 px-4 sm:px-6">
                ...
                <div className="flex items-center space-x-2 sm:space-x-3">
                    <Button 
                        ...
                        size="icon" 
                        className="relative"
                        onClick={handleNotificationsClick} // Añadido el onClick
                    >
                    ...
                    <div className="hidden sm:flex items-center space-x-2">
                        {!isSidebarCollapsed && (
                            <>
                                ...
                                <span className="text-sm font-medium text-gray-700 hidden md:inline">Administrador</span>
                            </>
                        )}
                    </div>
